...
// 2.명시적 형변환
//      명시적 형변환의 겨우, 더 작은 데이터타입의 공간에 더 큰 데이터타입의 값을 담을때 발생한다.
//      우리가 명시석으로 이러한 데이터타입으로 바꿔라! 라고 명령어를 적어주어야 한다!!!!
//      명시적 형변환은
//      변수 = (바꿀 타입)바꿀 값;
//      으로 형변환이 가능하다.
public class Ex05YtpeCasting {
    public static void main(String[] args) {
        ...
        //암시적 형변환이 일어난다.
        //이때엔 우리가 특별이 더 적어줄 코드는 없다.
        myInt = myByte;
        System.out.println("myInt의 현재값:"+myInt);
        
        //하지만 반대의 경우에선 시적 형변환을 하지 않으면 에러가 난다.
        myByte = (byte)myInt;
